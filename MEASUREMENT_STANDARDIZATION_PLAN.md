...
Maintained `process_raw_hyst` as a temporary bridge for unmigrated consumers. Checkpoint 17
physical validation remains explicitly **PENDING**. Checkpoint **19 only** is next: in-memory
PUND processing.
