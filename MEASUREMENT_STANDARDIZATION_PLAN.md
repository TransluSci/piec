...
| 10b | Next; not started | Runner: Synchronous reservation, non-daemon worker, thread-start failure, and close coordination. |
| 10c onward | Not started | Continue engine and family slices. |
