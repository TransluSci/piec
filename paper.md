...
Third, while existing frameworks provide robust scripting environments, they are not explicitly designed for seamless integration with modern AI/ML pipelines. PIEC’s type-consistent interfaces and modular measurement abstractions make it particularly well-suited for use in autonomous experimentation, where reproducibility, composability, and machine-readable structure are critical.
...
![Inheritance Diagram of PIEC Instruments](docs/source/_static/piec_inheritance_diagram.png){width="80%"}
