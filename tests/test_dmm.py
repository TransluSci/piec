"""
Consolidated Digital Multimeter (DMM) Category Tests.

Covers:
- Base class, channel declaration, class attributes, autodetect IDs
- Automatic discovery of all DMM drivers
- VirtualDMM configuration, reader injection, overload handling, reset
- Agilent 34410A SCPI command generation, tracking synchronization, parsing
- Keithley 2000 SCPI command generation, tracking synchronization, parsing
- Keithley 193A DDC command generation, rate mapping, regex parsing
- MokeMeasurement integration across all DMM drivers
- Optional capability gating and error handling
"""
...
class TestDMMDiscovery:
    """Verify that all advertised and discovered DMM drivers conform to standards."""
    ...
    def test_inherits_from_dmm(self, driver_cls):
        """Every DMM driver must inherit from DMM."""
        assert issubclass(driver_cls, DMM)

    @pytest.mark.parametrize("driver_cls", ALL_DMM_DRIVERS)
    def test_declares_channel_attribute(self, driver_cls):
        """Every DMM driver must define channel attribute as [1]."""
...
class TestVirtualDMMContract:
    ...
    def test_get_voltage_finite_and_non_finite_handling(self, v_dmm):
        ...
        assert math.isinf(v_inf) and v_inf > 0
...
# ============================================================================
# 3. Agilent34410A Contract Tests
# ============================================================================
...
class TestAgilent34410AContract:
    ...
    def test_quick_read(self, agilent):
        ...
        assert agilent.quick_read() == pytest.approx(0.005)
...
# ============================================================================
# 4. Keithley 2000 Contract Tests
# ============================================================================
...
# ============================================================================
# 5. Keithley 193A Contract Tests
# ============================================================================

class TestKeithley193aContract:
    """Verify Keithley 193A DDC command generation, rate mapping, and regex parsing."""
