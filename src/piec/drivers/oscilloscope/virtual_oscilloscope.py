...
class VirtualScope(VirtualInstrument, Oscilloscope):
    ...
    def __init__(self, address='VIRTUAL', **kwargs):
        ...
        Args:
            ...
            simulation_points (int, optional): Maximum number of samples
                generated by a synthetic acquisition. This is independent of
                the hardware ``acquisition_points`` capability.
    ...
    def simulation_points(self):
        """Maximum number of samples generated by a synthetic acquisition."""
